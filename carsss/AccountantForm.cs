...
namespace carsss
{
    public partial class AccountantForm : Form
    {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView2.Columns.Add("price", "Доход с НДФ");
        ...
        private void UpdateRow()
        {
            ...
            for(int i = 0; i < dataGridView2.Rows.Count; i++)
            {
                ...
                if(rowState == RoWState.Deleted)
                {
                    ...
                    var delQuery = $"delete from acctable where id = {id}";
                ...
                if(rowState == RoWState.Modified)
                {
                    ...
                    string updateQuery = $"update acctable set mark = '{mark}', color = '{color}', year = '{year}', cond = '{cond}', price = '{price}' where id = '{id}'";
        ...
        private void Search(DataGridView dgw)
        {
            ...
            string searchSql = $"select * from acctable where concat (id, mark, color, year, cond, price) like '%" + searchBox.Text + "%'";
